...
class ReporteDeConstruccionTest {
	...
	void testGetVolumenDeMaterial() {
		assertEquals(92,Math.round(this.reporteConMaterial.getVolumenDeMaterial("Hierro")));
		assertEquals(0,this.reporteSinMaterial.getVolumenDeMaterial("Madera"));
	}
	
	@Test
	void testGetSuperficieDeMaterial() {
		assertEquals(175,Math.round(this.reporteConMaterial.getSuperficieDeColor("Rojo")));
